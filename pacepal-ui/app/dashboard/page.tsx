  ...
  const fetchHistory = async () => {
    ...
    try {
      const res = await axios.get(
        "http://localhost:8080/api/sessions/my-history",
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 text-black">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 md:p-8">
        ...
        <div className="flex justify-between items-center mb-8 border-b pb-4">
          ...
          <span className="font-medium text-gray-700 underline decoration-indigo-300">
            Welcome, {user}!
          </span>
        </div>

        {/* Stats + Timer + chat own */}
        ...
        <div className="p-6 border rounded-xl bg-white shadow-sm border-indigo-100 flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-center mb-2">
              <h2 className="font-bold text-gray-700 text-lg uppercase">
                Daily Study Goal
              </h2>
              ...
              sessions
                ...
                .map((s) => (
                  <tr key={s.id}>
                    ...
                    <td className="px-6 py-4">{s.durationMinutes} mins</td>
